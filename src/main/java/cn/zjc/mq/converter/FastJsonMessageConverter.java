package cn.zjc.mq.converter;

import cn.zjc.config.RabbitMQConfiguration;
...
public class FastJsonMessageConverter extends AbstractJsonMessageConverter {
    ...
    protected Message createMessage(Object o, MessageProperties messageProperties) {
        ...
        try {
            ...
            data = source.getBytes(RabbitMQConfiguration.DEFAULT_CHARSET);
        ...
        messageProperties.setContentEncoding(RabbitMQConfiguration.DEFAULT_CHARSET);
        ...
        if (properties != null) {
            ...
            if (StringUtils.isNotBlank(contentType) && StringUtils.contains(contentType, "json")) {
                ...
                if (StringUtils.isBlank(encoding)) {
                    encoding = RabbitMQConfiguration.DEFAULT_CHARSET;
                }
                try {
                    if (this.getClassMapper() == null) {
